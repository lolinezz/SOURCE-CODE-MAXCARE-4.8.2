...
namespace maxcare
{
	...
	{
		// Token: 0x06000782 RID: 1922 RVA: 0x000D0E10 File Offset: 0x000CF010
		public fHDKetBanNewfeed(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			...
			this.type = type;
			bool flag = InteractSQL.GetTuongTac("", "HDKetBanNewfeed").Rows.Count == 0;
			if (flag)
			{
				maxcare.KichBan.Connector.Instance.ExecuteNonQuery("INSERT INTO \"main\".\"Tuong_Tac\" (\"TenTuongTac\", \"MoTa\") VALUES ('HDKetBanNewfeed', 'Kết bạn Newfeed');");
			}
			string jsonStringOrPathFile = "";
			bool flag2 = type == 0;
			if (flag2)
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDKetBanNewfeed");
		...
		// Token: 0x06000783 RID: 1923 RVA: 0x000D1058 File Offset: 0x000CF258
		...
		// Token: 0x06000784 RID: 1924 RVA: 0x000D1110 File Offset: 0x000CF310
		...
		// Token: 0x06000785 RID: 1925 RVA: 0x0004B984 File Offset: 0x00049B84
		private void button1_Click(object sender, EventArgs e)
		{
			base.Close();
		}

		// Token: 0x06000786 RID: 1926 RVA: 0x000D1294 File Offset: 0x000CF494
		...
		// Token: 0x06000787 RID: 1927 RVA: 0x0004B984 File Offset: 0x00049B84
		private void btnCancel_Click(object sender, EventArgs e)
		{
			base.Close();
		}

		// Token: 0x06000788 RID: 1928 RVA: 0x000D1560 File Offset: 0x000CF760
