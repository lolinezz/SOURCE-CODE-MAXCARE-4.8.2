...
namespace maxcare
{
	...
	public partial class fHDKetBanThanhVienNhom : Form
	{
		// Token: 0x06000BE4 RID: 3044 RVA: 0x001AB430 File Offset: 0x001A9630
		public fHDKetBanThanhVienNhom(string id_KichBan, int type = 0, string id_HanhDong = "")
		{
			this.InitializeComponent();
			this.ChangeLanguage();
			fHDKetBanThanhVienNhom.isSave = false;
			...
			if (flag)
			{
				DataTable tuongTac = InteractSQL.GetTuongTac("", "HDKetBanThanhVienNhom");
		...
		// Token: 0x06000BE5 RID: 3045 RVA: 0x001AB614 File Offset: 0x001A9814
		...
		// Token: 0x06000BE6 RID: 3046 RVA: 0x001AB6F0 File Offset: 0x001A98F0
		...
		// Token: 0x06000BE7 RID: 3047 RVA: 0x0004B984 File Offset: 0x00049B84
		private void button1_Click(object sender, EventArgs e)
		{
			base.Close();
		}

		// Token: 0x06000BE8 RID: 3048 RVA: 0x001AB870 File Offset: 0x001A9A70
				...
				else
				{
					...
					if (flag3)
					{
						...
						if (flag4)
						{
							...
							if (flag5)
							{
								fHDKetBanThanhVienNhom.isSave = true;
								base.Close();
							}
							else
							{
		...
		// Token: 0x06000BE9 RID: 3049 RVA: 0x0004B984 File Offset: 0x00049B84
		private void btnCancel_Click(object sender, EventArgs e)
		{
			base.Close();
		}

		// Token: 0x06000BEA RID: 3050 RVA: 0x001ABB9C File Offset: 0x001A9D9C
		...
		// Token: 0x06000BEB RID: 3051 RVA: 0x001ABC60 File Offset: 0x001A9E60
		private void txtComment_TextChanged(object sender, EventArgs e)
		{
			try
			{
				List<string> list = this.txtUid.Lines.ToList<string>();
				list = MCommon.Common.RemoveEmptyItems(list);
				this.lblStatus.Text = string.Format(Language.GetValue("Danh sách Uid nhóm ({0}):"), list.Count.ToString());
			}
			catch
			{
			}
